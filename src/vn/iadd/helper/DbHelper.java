...
public class DbHelper implements AutoCloseable {
	...
	/*public DbHelper() {
		this("jdbc:oracle:thin:@10.4.18.113:1521/ORCL.ORACLE.POC", "dainv", "Hpt123456");
	}*/
	
	public DbHelper() {
		this(ConfigUtils.getConfig("DB_HOST"), ConfigUtils.getConfig("DB_USER"), ConfigUtils.getConfig("DB_PASS"));
	}
	...
	static void testQuery() throws Exception {
		...
		final String query = "select * from oim_ws_configuration";
		...
		while (it.hasNext()) {
			...
			OimWsConfiguration obj = OimWsConfiguration.fromMap(map);
